          ...
          {isLoggedIn ? (
            <>
              ...
              <button
                ...
                className="h-8 w-8 rounded-full bg-[var(--discord-blurple)] flex items-center justify-center text-xs font-bold text-foreground"
              >
                PF
              </button>
            </>
            ...
            <button onClick={() => setIsLoggedIn(true)}
              className="py-3 hidden md:inline-flex bg-[var(--discord-blurple)] hover:bg-[var(--discord-blurple-hover)] text-foreground gap-2 rounded-md px-3 py-1 text-sm font-medium transition-colors "
            >  
